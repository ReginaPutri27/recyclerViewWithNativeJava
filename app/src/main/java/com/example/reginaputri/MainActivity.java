...
public class MainActivity extends AppCompatActivity {
    ...
    private void showRecyclerList(){
        ...
        rvCategory.setAdapter(listHeroesAdapter);
    ...
    private void showRecyclerGrid(){
        ...
        GridHeroesAdapter gridHeroesAdapter = new GridHeroesAdapter(this);
        gridHeroesAdapter.setListHeroes(list);
        rvCategory.setAdapter(gridHeroesAdapter);
    ...
    private void showRecyclerCardView() {
        rvCategory.setLayoutManager(new LinearLayoutManager(this));
        CardViewHeroesAdapter cardViewHeroesAdapter = new CardViewHeroesAdapter(this);
        cardViewHeroesAdapter.setListHeroes(list);
        rvCategory.setAdapter(cardViewHeroesAdapter);
    }
